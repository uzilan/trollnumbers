import trollnumbers.TrollNumber.{Lots, Many, One, Three, Two}
import trollnumbers.TrollsDontDoBigNumbersException

class TrollNumberSpec extends org.specs2.mutable.Specification {
